    ...
    public partial class GoldReceipt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dtCheck.Rows.Count > 0)
            {
                ...
                lbl_branch.Text = Convert.ToString(dtCheck.Rows[0][3]);
                lbl_goldno.Text = Convert.ToString(dtCheck.Rows[0][4]);
                lbl_date.Text = Convert.ToString(dtCheck.Rows[0][5]);
                lbl_amount.Text = Convert.ToString(dtCheck.Rows[0][6]);
