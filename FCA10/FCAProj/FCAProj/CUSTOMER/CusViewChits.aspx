...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td>
                 <asp:GridView ID="Gridcuschitview" runat="server" AutoGenerateColumns="False" style="margin-left: 362px; margin-top: 89px" CellPadding="4" ForeColor="#333333" GridLines="None" 
                   OnSelectedIndexChanged="Gridcuschitview_SelectedIndexChanged" >
