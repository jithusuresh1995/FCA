       ...
       // public string Cdob { get => cdob; set => cdob = value; }
        ...
        public void Insertcustomer()
        {
            ...
            string qry = "insert into tblCustomerregistration "+
                    ...
                    " ,[C_idproof] ,[C_proofno] ,[C_photo] ,[C_username] ,[C_password]  ,[Branch_id],[Account_No])" +
                    "values (@name,@address,@gender,@dob,@phone,@email,@district,@city,@idproof,@proofno,@photo,@username,@password,@branchid,@accountno);";
