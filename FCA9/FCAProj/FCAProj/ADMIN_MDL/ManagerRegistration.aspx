     ...
     <table class="nav-justified" style="width: 100%; height: 100%; border-collapse:separate;border-spacing:10px;">
        ...
        <tr>
            ...
            <td style="height: 20px; width: 227px;">
                <asp:RadioButton ID="rbm_male" runat="server" GroupName="gen" Text="Male" Width="200px" />
                <asp:RadioButton ID="rbm_female" runat="server" GroupName="gen" Text="Female" Width="200px" />
            </td>
...
&nbsp; </td>
        ...
        <tr>
            ...
            <td style="height: 35px; width: 227px;"></td>
