...
namespace FCAProj.EMPLOYEE_MDL
{
    public partial class Chitmemberdetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (chitno.Rows.Count > 0)
                {
                    ...
                    dd_chitnumber.Items.Insert(0, new ListItem("--Select--", "0"));
                }
                ...
                if (cus.Rows.Count > 0)
                {
                    ...
                    dd_customer.Items.Insert(0, new ListItem("--Select--", "0"));
                }
            }
        }
        ...
        protected void btn_add_Click(object sender, EventArgs e)
        {
            ...
            txt_joindate.Text = "";
            dd_chitnumber.ClearSelection();
            dd_customer.ClearSelection();
        }
