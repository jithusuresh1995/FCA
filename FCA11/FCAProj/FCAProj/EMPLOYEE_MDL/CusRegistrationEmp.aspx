<%@ Page Title="" Language="C#" MasterPageFile="~/EMPLOYEE_MDL/Employee.Master" AutoEventWireup="true" CodeBehind="CusRegistrationEmp.aspx.cs" Inherits="FCAProj.EMPLOYEE_MDL.CusRegistrationEmp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified" style="width: 100%; height: 100%; border-collapse:separate;border-spacing:5px;">
        ...
        <tr>
            ...
            <td style="font-size: large; font-weight: bold; color: #000080; font-style: italic;" colspan="2" rowspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CUSTOMER&nbsp; REGISTRATION</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="height: 20px">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="dd_district" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
            <td style="height: 20px"></td>
        ...
        <tr>
            ...
            <td style="height: 20px">
                <asp:FileUpload ID="file_photo" runat="server" Width="150px" />
            </td>
            <td style="height: 20px"></td>
        </tr>
        <tr>
            ...
            <td style="height: 20px">
                <asp:TextBox ID="txt_username" runat="server" OnTextChanged="txt_username_TextChanged" Width="150px"></asp:TextBox>
