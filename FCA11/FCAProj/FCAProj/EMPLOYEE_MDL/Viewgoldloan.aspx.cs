...
namespace FCAProj.EMPLOYEE_MDL
{
    public partial class Viewgoldloan : System.Web.UI.Page
    {
        ...
        protected void Gridviewloan_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                obj1.Mid = Convert.ToInt32(Session["BranchId"]);
                ...
                dtReg1 = obj1.fetchrate();
                if (dtReg1.Rows.Count > 0)
                {

                    //obj1.Loandate = Convert.ToString(dtReg1.Rows[0]["Date"]);
                    obj1.Rate = Convert.ToDouble(dtReg1.Rows[0]["L_interestrate"]);
                }
                ...
                double r = obj1.Rate;
                double interestamount = (amt * n * r) / (365 * 100);
        ...
        protected void btn_Epay_Click1(object sender, EventArgs e)
        {
