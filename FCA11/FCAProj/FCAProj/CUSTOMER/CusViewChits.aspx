...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td>
                 <asp:GridView ID="Gridcuschitview" runat="server" AutoGenerateColumns="False" style="margin-left: 323px; margin-top: 89px" CellPadding="4" ForeColor="#333333" GridLines="None" 
                   OnSelectedIndexChanged="Gridcuschitview_SelectedIndexChanged" Width="402px" DataKeyNames="SN">
        ...
        <Columns>
           ...
           <asp:BoundField DataField="Chit_amount" HeaderText ="Amount">
             ...
             <asp:BoundField DataField="chit_Stardate" HeaderText ="Start date" >
                ...
                <asp:CommandField  runat="server" CausesValidation="false" ShowSelectButton="true" ButtonType="Button"
                    SelectText="Make Auction"  />
