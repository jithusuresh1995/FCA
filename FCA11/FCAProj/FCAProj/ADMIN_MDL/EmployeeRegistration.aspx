    ...
    <table class="nav-justified" style="width: 100%; height: 100%; border-collapse:separate;border-spacing:10px;">
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 243px">
                <asp:DropDownList ID="ddE_branchname" runat="server" Width="150px" CausesValidation="True">
                </asp:DropDownList>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddE_branchname" ErrorMessage="Select the name"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 20px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txte_name" ErrorMessage="Enter the name"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 361px"></td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txte_address" ErrorMessage="Enter the address"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 361px">&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txte_dob" ErrorMessage="Enter the dob"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="height: 20px; width: 361px"></td>
            ...
            <td style="height: 20px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txte_phone" ErrorMessage="Enter the phn number"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="height: 20px; width: 361px"></td>
            ...
            <td style="height: 20px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txte_email" ErrorMessage="Enter the email"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="height: 20px; width: 361px"></td>
            ...
            <td style="height: 20px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="dd_emstatus" ErrorMessage="Select the status"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 24px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txte_joindate" ErrorMessage="Enter the joining date"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 361px">&nbsp;</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="dde_designation" ErrorMessage="Enter the designation"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 361px">&nbsp;</td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="filee_photo" ErrorMessage="Please attach your photo"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 361px">&nbsp;</td>
