...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        ...
        <tr>
            <td style="width: 117px">&nbsp;</td>
            <td>
                <asp:GridView ID="Gridviewmanager" runat="server" AutoGenerateColumns="False" OnRowCommand="Gridviewmanager_RowCommand"  CellPadding="6" ForeColor="#333333" GridLines="None"  AlternatingRowStyle-CssClass="bottomBorder" OnSelectedIndexChanged="Gridviewmanager_SelectedIndexChanged" style="margin-left: 0px" Width="887px" >
           ...
           <asp:BoundField DataField="M_address" HeaderText ="Addresss">
            ...
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("M_photo") %>' Hight="50px" Width="50px "/>
            </ItemTemplate>
        </asp:TemplateField>
                          <asp:TemplateField ShowHeader="False">
            <ItemTemplate>
