...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        <tr>
            <td style="width: 176px; height: 59px;"></td>
            <td style="width: 587px; height: 59px;"></td>
            <td style="height: 59px"></td>
        </tr>
        <tr>
            <td style="width: 176px; height: 45px;">&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 587px">
                ...
                <asp:GridView ID="Gridviewbranch" runat="server" AutoGenerateColumns="False" Height="16px" Width="729px" OnRowCommand="Gridviewbranch_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <tr>
            <td style="width: 176px; height: 20px;"></td>
            <td style="width: 587px; height: 20px;"></td>
            <td style="height: 20px"></td>
        </tr>
        <tr>
            <td style="width: 176px; height: 456px;"></td>
