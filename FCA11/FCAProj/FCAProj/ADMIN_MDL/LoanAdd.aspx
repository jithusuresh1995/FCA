...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <table class="nav-justified" style="width: 100%; height: 100%; border-collapse:separate;border-spacing:5px;">
        ...
        <tr>
            <td style="width: 326px">&nbsp;</td>
            <td style="font-size: medium; font-weight: bold;" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ADD LOANS&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td style="width: 326px">&nbsp;</td>
        ...
        <tr>
            <td style="height: 22px; width: 326px"></td>
        ...
        <tr>
            <td style="height: 108px; width: 326px;"></td>
            <td style="height: 108px; width: 155px;">&nbsp;</td>
