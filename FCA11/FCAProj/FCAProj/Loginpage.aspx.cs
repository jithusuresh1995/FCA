        ...
        protected void btn_login_Click1(object sender, EventArgs e)
        {
            ...
            if (dtReg.Rows.Count != 0)
            {
                ...
                if (Convert.ToString(dtReg.Rows[0]["Login_type"]) == "Mgr")
                {
                   ...
                   // Session["logid"] = Convert.ToString(dtReg.Rows[0]["Login_id"]);
                ...
                if (Convert.ToString(dtReg.Rows[0]["Login_type"]) == "Emp")
                {
                    ...
                    Session["BranchId"] = Convert.ToString(dtReg.Rows[0]["EmpBranchid"]);
                    //Session["logid"] = Convert.ToString(dtReg.Rows[0]["Login_id"]);
                ...
                if (Convert.ToString(dtReg.Rows[0]["Login_type"]) == "Cus")
                {
                    ...
                    //["Bid"] = Convert.ToString(dtReg.Rows[0]["Branch_id"]);
